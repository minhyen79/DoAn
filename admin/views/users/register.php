...
<div class="register-alert register-alert-animate">
	...
	<a href="index.php?mod=login"><button>OK</button></a>
</div>
<!-- ./sweet-alert -->
<!-- account  -->
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 col-12 ml-auto mr-auto">
					...
					<div class="account-content">
						...
						<form action="" method="POST" onsubmit="return registerForm();">
							...
							<div class="account-title">
								...
								<p class="account-desc">Flowers là trang web bán thực phẩm uy tín số 1, Đăng nhập vào để nhập các ưu đãi lớn.</p>
				            ...
				            <div class="account-form account-tab">
				                ...
				                <div class="account-form-inp">
				                  ...
				                  <input onblur="checkEmailRegister();"  type="email" class="input-email" id="input-email" name="" placeholder="Eg: Flowers.com" autocomplete="current-email">
					...
					<div class="account-t-register">
						<p>Bạn đã có tài khoản? <a href="index.php?mod=login" class="fg-text-primary">Đăng nhập</a></p>
					</div>
					<!-- ./tab-register -->
				</div>
			</div>
