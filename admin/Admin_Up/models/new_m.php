<?php  
	...
	class new_m extends Connect
	{
	    ...
	    {	
	    	$sql = "SELECT tbl_news.id_news, tbl_news.title, tbl_news.main_image
					FROM tbl_news
					ORDER BY tbl_news.id_news DESC";
	    ...
	    public function getCategoryforNews()
	    {
		...
		public function updateNews($id_news,$id_category_new,$id_user,$classify,$title,$main_image,$description,$main_content)
		{
			$sql = "UPDATE tbl_news SET id_category_new = :id_category_new, id_user = :id_user, classify = :classify, title = :title, main_image = :main_image, description = :description, main_content = :main_content WHERE id_news = :id_news";
