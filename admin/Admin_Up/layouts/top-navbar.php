    ...
    <ul class="list-unstyled topnav-menu float-right mb-0">
        ...
        <li class="dropdown notification-list">
            <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                ...
                <span class="d-none d-sm-inline-block ml-1 font-weight-medium"><?php if (isset($_SESSION['name'])) {
                    echo $_SESSION['name'];
                } ?></span>
            ...
            <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                ...
                <div class="dropdown-header noti-title">
                    <h6 class="text-overflow text-white m-0">Webcome !</h6>
                </div>
                ...
                <!-- item-->
                <a onclick="return confirm('Do you want logout now ?')" href="index.php?page=user&act=logout" class="dropdown-item notify-item">
