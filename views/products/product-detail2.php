    			...
    			<div class="col-lg-7 col-md-7">
    				...
    				<div class="productDetail-r">
                        ...
                        <div class="product-social">
                            ...
                            <ul>
                                <li class="fb-share-button" data-href="http://btsphim.online/chi-tiet-san-pham/<?php echo $product['id_product']; ?>" data-layout="button" data-size="small">
                                    <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fbtsphim.online%2Fchi-tiet-san-pham%2F<?php echo $product['id_product']; ?>&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore" title="chia sẻ sản phẩm lên facebook">
                                        <i class="fa fa-facebook"></i> Facebook 
                                        <head>
                                            <meta property="og:url"           content="http://btsphim.online/chi-tiet-san-pham/<?php echo $product['id_product']; ?>" />
